...
/**
This function prints numbers 0-99 using endls
*/
void print_endl();

/**
This function prints numbers 0-99 using new lines
*/
void print_newline();
...
void print_endl(){ 
	for(int i=0; i < 100; ++i){ // print 0 to 99 with endl
		std::cout << i << std::endl;
	}
}

void print_newline(){ 
	for(int i=0; i < 100; ++i){ // print 0 to 99 with \n
		std::cout << i << '\n';
	}
}
